    ...
    <Listbox value={selected} onChange={setSelected}>
      {({ open }) => (
        <>
          ...
          <div className="mt-1 relative SelectInput" style={{ minWidth: 200 }}>
            <Listbox.Button className="relative border-2 border-primary  w-full bg-secondary  rounded-sm  shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 sm:text-sm">
